...
<template>
    <div>
        ...
        <fwb-table hoverable class="mb-4">
            <fwb-table-head>
                <fwb-table-head-cell>Назва</fwb-table-head-cell>
            ...
            <fwb-table-body>
                ...
                <fwb-table-row v-for="item in categories" :key="item.id">
                    <fwb-table-cell>{{ item.title }}</fwb-table-cell>
                    <fwb-table-cell>{{ item.type.title }}</fwb-table-cell>
        ...
        <fwb-pagination v-model="currentPage" :total-items="categories.length" show-icons previous-label=""
